...
List<org.computeforcancer.android.Message> getEventLogMessages(in int seq, in int num);  // implement: call clientInterface.getEventLogMessages(int, Integer);
List<org.computeforcancer.android.Message> getMessages(in int seq);        // implement: call clientInterface.getMessages(Integer);
